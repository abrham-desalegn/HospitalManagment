<%-- 
    ...
    Created on : Jun 11, 2023, 1:22:01 PM
    Author     : Abrham
--%>
    ...
    <body>
        ...
        <div class="container-contact100">
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="addPatient.jsp" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Phone is required">
                        ...
                        <input  title="number only" class="input100" type="number"  title='Phone No. must contain digits only' name="mobile" placeholder="re-Enter phone number">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Age is required">
                        ...
                        <input   class="input100" type="number"  title='Age must contain digits only' name="age" placeholder="re-Enter Age">
                        <span class="focus-input100"></span>
                    </div>
