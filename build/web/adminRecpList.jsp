...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center;color: white">List of all Workers</h1>
       <table>
    <tr>
      <th>First_Name</th>
      <th>Second_Name</th>
    ...
    ResultSet resultSet = pst.executeQuery("select * from  worker");
    %>
    <%
    ...
    <tr>
      ...
      <td><%=resultSet.getString(4)%></td>
        <td><form action="WorkerUpdate.jsp" >
                      <input type="hidden" value="<%=resultSet.getString(3)%>" name="mobile">
                      <input type="submit" value="Edit">
      </form></td>
      <td><form action="WorkerUp.jsp" >
                      <input type="hidden" value="<%=resultSet.getString(3)%>" name="mobile">
