<%-- 
    ...
    Created on : Jun 11, 2023, 10:47:16 AM
    Author     : Abrham
--%>
<!DOCTYPE html>
...
<jsp:useBean id = "storePatientId" class = "beanPack.StorePatient" scope = "application"></jsp:useBean>
    <%
            ...
            String tr = request.getParameter("edit");
    ...
    <body>
        ...
        <div class="container-contact100">
            ...
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="updatemedicine.jsp" method="post">

                    <div class="wrap-input100 validate-input" data-validate="First Name is required">
                        <span class="label-input100">Medicine Name:</span>
                        <input class="input100" type="text" name="mname" placeholder= "re-enter MedicineName" >
                        <span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Last Name is required">
                        <span class="label-input100">Medicine ID:</span>
                        <input class="input100" type="text" name="mid" placeholder="re-Enter MEdicineID">
                        <span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Phone is required">
                        <span class="label-input100">Quantity:</span>
                        <input class="input100" type="text" name="quantity" placeholder= "re-enter quantitiy">
                        <span class="focus-input100"></span>
                    </div>
