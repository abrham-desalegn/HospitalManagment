<%-- 
    ...
    Created on : Jun 9, 2023, 1:41:20 PM
    Author     : Abrham
--%>
...
<html>
    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <h1 style="text-align: center;color: white">List of all Doctors</h1>
       <table>
    <tr>
      <th>ID</th>
      <th>First_Name</th>
    ...
    ResultSet resultSet = pst.executeQuery("select * from  doctor");
    %>
    <%
    ...
    <tr>
      ...
      <td><form action="doctorupdate.jsp" >
                <input type="hidden" value="<%=resultSet.getString(1)%>" name="id">
                <input type="submit" value="Edit">
       </form></td>
      <td><form action="DoctorUp.jsp" >
                <input type="hidden" value="<%=resultSet.getString(1)%>" name="id">
