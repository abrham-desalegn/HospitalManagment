...
<jsp:useBean id = "recpId" class = "beanPack.RecpBean" scope = "session"></jsp:useBean>
<jsp:setProperty name = "recpId" property = "*" />
<jsp:useBean id = "storePatientId" class = "beanPack.StorePatient" scope = "application"></jsp:useBean>
       <%
            ...
            PreparedStatement st = con.prepareStatement("select Phone from worker where Phone = ?");
        ...
        window.location.href = "addRecp.html";
      </script>
              <% } else {
        ...
        pst.setString(1, recpId.getFname());
        pst.setString(2, recpId.getLname());
        pst.setString(3,recpId.getMobile());
        ...
        <div class="container-contact100">
            <div class="wrap-contact100">
                ...
                <form class="contact100-form validate-form"  action="adminHome.html" method="post">
                    ...
                    <p style=" font-size: 15px">ID  : <%= recpId.getFname()%></p>
                    <p style=" font-size: 15px">First Name : <%= recpId.getLname() %></p>
                    <p style=" font-size: 15px">Last Name : <%= recpId.getMobile() %></p>
